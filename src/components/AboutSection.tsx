...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative py-24 bg-secondary/50" ref={sectionRef}>
      {/* Background Animation Elements */}
      <div className="absolute top-0 left-0 right-0 bottom-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[5%] right-[5%] w-56 h-56 bg-gradient-blue rounded-full blur-3xl opacity-10 floating-animation" style={{ animationDelay: '3s' }} />
        <div className="absolute bottom-[5%] left-[5%] w-48 h-48 bg-gradient-cyan rounded-full blur-3xl opacity-10 pulse-animation" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="container relative mx-auto px-6 md:px-12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 staggered-animation">
          <div className="bg-background rounded-xl p-8 shadow-sm border border-border/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div className="w-12 h-12 bg-gradient-blue rounded-lg flex items-center justify-center mb-6 text-white pulse-animation">
          ...
          <div className="bg-background rounded-xl p-8 shadow-sm border border-border/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div className="w-12 h-12 bg-gradient-cyan rounded-lg flex items-center justify-center mb-6 text-white pulse-animation" style={{ animationDelay: '1s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <div className="bg-background rounded-xl p-8 shadow-sm border border-border/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div className="w-12 h-12 bg-gradient-blue rounded-lg flex items-center justify-center mb-6 text-white pulse-animation" style={{ animationDelay: '2s' }}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="mt-16 bg-background rounded-xl p-8 shadow-sm border border-border/50">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className={cn(
              ...
              <div className="rounded-xl overflow-hidden h-full relative animated-border">
